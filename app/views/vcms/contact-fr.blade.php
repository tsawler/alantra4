...
@section('content')
    ...
    <div class="col-md-8">
        ...
        <p>
            Vous pouvez aussi <a href="/quote">Demander un estimé</a> et nous communiquerons avec vous dans les deux heures qui
        ...
        <p>
            ...
            <a href="https://www.google.ca/maps/place/98+Cougle+Rd,+Sussex+Corner,+NB+E4E+2S6/@45.7246302,-65.4709224,15z/data=!4m2!3m1!1s0x4ca722cec36ef9bb:0xc52dd29c7a4db238" target="_blank">Comment nous trouver</a>.
        </p>

        <p>
            Nos <a href="/distribution-centres">centres de distribution</a> sont situés à des endroits facilement accessibles dans tout l’Est canadien.
        ...
        <a href="tel:18004561800>"<i class="fa fa-fw fa-phone"></i></a> Tél sans frais : 800-456-1800<br>
