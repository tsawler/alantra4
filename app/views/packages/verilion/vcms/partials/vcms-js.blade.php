        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id="ddmodalbody">
                    ...
                    <form id="ddmenuItemForm" class="form-horizontal" name="ddmenuItemForm" method="post"
                          action="/menu/saveddmenuitem">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="menu_page_id" id="ddmenu_page_id" class="form-control">
                                                ...
                                                @foreach(verilion\vcms\Page::orderBy('page_title', 'ASC')->get() as $item)
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id="modalbody">
                    ...
                    <form id="menuItemForm" class="form-horizontal" name="menuItemForm" method="post"
                          action="/menu/savemenuitem">
...
@if (Config::get('vcms::use_french'))
    @if ((Session::has('lang')) && (Session::get('lang') == 'fr'))
        <script src="/packages/verilion/vcms/fullcal/lang/fr-ca.js"></script>
    @endif
@endif
...
@if((Auth::check()) && (Auth::user()->access_level == 3))
    ...
    <script src="/packages/verilion/vcms/js/contextmenu/jquery.ui.position.js"></script>
    <script src="/packages/verilion/vcms/js/jquery.sortable.min.js"></script>
