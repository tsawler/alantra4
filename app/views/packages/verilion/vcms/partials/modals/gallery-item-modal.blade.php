        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    {{ Form::text('item_description', null, ['id' => 'item_description', 'class' => 'form-control']) }}
                </div>
                ...
                @if (Config::get('vcms::use_french'))
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('item_description_fr', null, ['id' => 'item_description_fr', 'class' => 'requied form-control']) }}
                    </div>
                @endif
