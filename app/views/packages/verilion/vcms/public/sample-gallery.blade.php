...
@section('css')
<link rel="stylesheet" href="/packages/verilion/vcms/plugins/cubeportfolio/css/cubeportfolio.min.css">
<style>
.image-style-one {
    width: 200px;
}
...
<div class="portfolio pf-one">
    ...
    <div class="portfolio-content">
        <div id="filters">
            ...
            @foreach((verilion\vcms\Gallery::where('active','=','1')
        ...
        <?php
        $items = \verilion\vcms\GalleryItem::whereRaw('gallery_id in (select id from galleries where active = 1)')
            ->where('active', '=', 1)
            ->orderBy('item_name')
            ->get();
        ?>
...
@stop
@section('bottom-js')
<script src="/packages/verilion/vcms/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js"></script>

<!-- Imageloaded -->
<script src="/packages/verilion/vcms/assets/js/imagesloaded.min.js"></script>
<!-- Isotope -->
<script src="/packages/verilion/vcms/assets/js/isotope.js"></script>
