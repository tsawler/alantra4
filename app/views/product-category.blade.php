                ...
                <?php
                    ...
                    if (sizeof($images) > 0){
                        ...
                        <a href="/products/product/{{ $item->slug }}">
                            <img class='img img-responsive thumbnail' src="/product_images/thumbs/{{ $images[0]->image_name }}">
                        </a>
                        <?php
                    } else {
                        ?>
                        <a href="/products/product/{{ $item->slug }}">
                            <img class='img img-responsive thumbnail' src="http://placehold.it/350x350&text=No+Image">
                        </a>
                        <?php
                    }
                ?>
